...
Route::prefix('pages')->group(function () {
    // Route::get('about', [PageController::class, 'about']); // About page
    Route::get('background', [PageController::class, 'background'])->name('background'); // My background page
    Route::get('experience', [PageController::class, 'experience'])->name('experience'); // My Experience page
    Route::get('projects', [PageController::class, 'projects'])->name('projects'); // Projects Page
    Route::get('image-example', [PageController::class, 'interventionExample']); // Image Intervention Example page
    Route::get('upload', [PageController::class, 'upload']); // Image Upload page
    Route::get('skills-rundown', [PageController::class, 'skillSRundown'])->name('skills-rundown');
