...
<div class="static-content code-sample-page projects">
    ...
    <div class="project-container">
        ...
        <p style="font-weight: bold">Note: Outdated styling, will be moving site to WordPress or Drupal and a new host.</p>
        <p>Website URL: No longer hosted</p>
    ...
    <div class="project-container">
        ...
        <p style="font-weight: bold">Note: This is my original portfolio site from 2015. For display purposes only.</p>
    ...
    <div class="project-container">
        <div><br /><span class="page-header mid-size-font">Musicbytes.us</span><br /></div>
        <p style="font-weight: bold">Note: This site was rebranded as The Music Pavillion in 2018, no longer hosted.</p>
