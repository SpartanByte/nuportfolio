...
@section('title', 'Python Information')

@section('content')
<div class="static-content general-coding">
    <span class="page-header uppercase-shadow mid-size-font">Python Code Samples</span><hr />

    <img class="coding-logo" src="/images/logos/python-grey-block.png">
    <div><span class="page-header mid-size-font">About Python</span></div>
    ...
    <p>As in PHP, JavaScript, C#, Java and so forth: <code>/* This is a multiline comment in many programming languages such as PHP and C# */</code><br />
        A comment in Python resembles config files:  <code> # This is a comment in Python (multiline or single line)</code>.</p>
    <p>A function in PHP: <code>function nameYourFunction($parameter1, $parameter2){</code>... and so forth. <br />
    ...
    {{-- Start of Examples --}}
    <ul class="file-list med-size-font python">
        <li><img src="/images/language-icons/python.png"/>
            <a href="/files/python/PositiveNumberSum.py">Postive Number Sum (Console Program)</a>
        </li>
        <li><img src="/icons/file-icons/txt-file.png" />
            <a href="/files/python/PositiveNumberSum.txt">Positive Number Sum (.txt file)</a>
        </li>
        <li><img src="/images/language-icons/python.png"/>
            <a href="/files/python/BudgetSubtractor.py">Budget Subtractor</a>
        </li>
        <li><img src="/icons/file-icons/txt-file.png" />
            <a href="/files/python/BudgetSubtractor.txt">Budget Subtractor (txt File)</a>
        </li>
        <li><img src="/images/language-icons/python.png"/>
            <a href="/files/python/SochiOlympicTimeclock.py">Sochi Olympics Time Converter (Console Program)</a>
        </li>
        <li><img src="/icons/file-icons/txt-file.png" />
            <a href="/files/python/SochiOlympicTimeclock.txt">Sochi Olympics Time Converter (txt File)</a>
        </li>
        <li><img src="/images/language-icons/python.png"/>
            <a href="/files/python/PaintCostCalculator.py">Paint Cost Calculator (Console Program)</a>
        </li>
        <li><img src="/icons/file-icons/txt-file.png" />
            <a href="/files/python/PaintCostCalculator.txt">Paint Cost Calculator (txt File)</a>
        </li>
        <li><img src="/images/language-icons/python.png"/>
            <a href="/files/python/BuildingInsuranceCalculator.py">Building Insurance Calculator (Console Program)</a>
        </li>
        <li><img src="/icons/file-icons/txt-file.png" />
            <a href="/files/python/BuildingInsuranceCalculator.txt">Building Insurance Calculator (txt File)</a>
        </li>
        <li><img src="/images/language-icons/python.png"/>
            <a href="/files/python/BMICalculator.py">BMI (Body Mass Indicator) Calculator (Console Program)</a>
        </li>
        <li><img src="/icons/file-icons/txt-file.png"/>
            <a href="/files/python/BMICalculator.txt">BMI (Body Mass Indicator) Calculator (txt File)</a>
        </li>
    </ul>
    <hr />
</div>
