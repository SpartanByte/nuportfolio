...
<div class="static-content code-sample-page">
    ...
    <span class="page-header mid-size-font">CSS (Cascading Stylesheets)</span><hr />

    <img class="coding-logo" src="/images/logos/css3-blue-block.jpg">
    <div><span class="page-header mid-size-font">CSS</span></div>
    ...
    <a href="https://daneden.github.io/animate.css/" target="_blank" title="Animate.css" alt="Animate.css library on GitHub">
        <img class="coding-logo" src="/images/logos/animate-css.png"/></a>
