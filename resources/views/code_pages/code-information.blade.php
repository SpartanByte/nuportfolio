    ...
    <div class="static-content">
        ...
        <hr />  
                <img src="https://dummyimage.com/450x300/000/fff" />
        <h3>C# (and ASP.NET)</h3>
            <p>Enter your details on C# and ASP.NET (what you know thus far) as well as JavaScripts growing interaction with ASP. Of course, also note <strong>Umbraco</strong>, a very powerful/developer friendly ASP.NET CMS </p>
        <hr /> 
    </div>
